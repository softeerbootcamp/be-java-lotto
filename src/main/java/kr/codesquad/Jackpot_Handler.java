...
public class Jackpot_Handler {
    ...
    public int ret1_if_contains(int i, ArrayList<Integer> my, ArrayList<Integer> jk){
    ...
    public void jackpot_cnts(ArrayList<Integer> my, ArrayList<Integer> jk){
        int cnt=0;
    ...
    public void finding_jackpot(My_lotto myLotto){
